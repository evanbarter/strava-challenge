...
export default function Segment({ afterAction, segment }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row px-6 pb-3 hover:bg-gray-300 hover:shadow-inner">
            <div className="flex flex-col flex-grow">
                <h3 className="text-3xl sm:text-4xl font-semibold italic">
                    {segment.name}
                </h3>
            ...
            <div className="flex-initial flex justify-center space-x-6">
                <div onClick={addChallenge.bind(this, segment.id, segment.name, segment.athlete_pr_effort ? segment.athlete_pr_effort.elapsed_time : false)} className="flex-initial flex flex-col items-center justify-center mt-3 p-2 rounded-lg cursor-pointer bg-white hover:bg-gray-100 hover:text-gray-900">
                ...
                <a href={`https://www.strava.com/segments/${segment.id}`} target="_blank" className="flex-initial flex flex-col items-center justify-center mt-3 p-2 rounded-lg cursor-pointer bg-white text-orange-500 hover:text-white hover:bg-orange-500">
