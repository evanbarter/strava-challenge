...
export default function Segment({ afterAction, segment }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row px-6 pb-3 hover:bg-purple-700 hover:shadow-inner">
            ...
            <div className="flex-initial flex justify-center space-x-6">
                ...
                <a href={`https://www.strava.com/segments/${segment.id}`} target="_blank" className="flex-initial flex flex-col items-center justify-center mt-3 p-2 rounded cursor-pointer hover:bg-white hover:text-purple-900">
