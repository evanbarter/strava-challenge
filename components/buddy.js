...
export default function Buddy({ buddy }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row pt-3 sm:pt-0 items-center px-6 space-x-6 hover:bg-purple-700 hover:shadow-inner">
            <div>
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <span className="text-xs text-purple-200 font-medium">has similar goals</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center mb-3">
                <a href={`https://www.strava.com/athletes/${buddy[name].strava}`} target="_blank" className="flex-initial flex flex-col items-center justify-center mt-3 p-2 rounded cursor-pointer hover:bg-white hover:text-purple-900">
