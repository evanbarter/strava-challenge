                ...
                { editing
                    ? (
                        ...
                        <div className="flex items-center justify-center mt-1 space-x-2">
                            <button onClick={updateChallenge.bind(this, challenge.segment_id)} className="h-6 w-6 inline text-lg bg-purple-600 text-purple-200 hover:bg-purple-700 hover:text-white shadow rounded px-2">✔</button>
                            <button onClick={() => { setEditing(false) }} className="h-6 w-6 inline bg-purple-600 text-purple-200 hover:bg-purple-700 hover:text-white shadow rounded px-2">
                    ...
                    : (
                        <span className="text-xl font-bold">
                            {secsToTime(challenge.time_to_beat)} {canEdit ? <button className="text-sm bg-purple-600 text-purple-800 hover:bg-purple-700 hover:text-white shadow rounded px-2 py-1" onClick={() => { setEditing(true) }}>✏️</button> : ''}
                        </span>
                    )
                }
